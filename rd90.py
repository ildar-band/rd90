...
def equivalent_amount_2(k1237, dovsoa, air_t, substance_mount, under_press):
    # Определение эквивалентного количества вещества во вторичном облаке Qэ2 = (1 - К1) К2 К3 К4 К5 К6 К7
    return (1 - k1237.k1) * k1237.k2 * k1237.k3 * get_k5(dovsoa) * get_k7(k1237, air_t, cloud=1) * substance_mount
